...
type RefundAuditRepository interface {
	...
	GetRefundAuditByOrderNo(ctx context.Context, refundOrderNo string) (*domain.RefundAudit, error)
	// GetRefundAuditByBillID 根据账单 id 查询 Pending 状态的退款审核记录
	GetRefundAuditByBillID(ctx context.Context, billID int64) (*domain.RefundAudit, error)
