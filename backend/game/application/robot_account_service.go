...
// for newly created robot accounts. It corresponds to the "Sala de 10" room.
const defaultRoomFee = 1000
...
// BatchCreateRobots creates the given number of robot accounts and registers
